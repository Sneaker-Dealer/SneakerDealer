...
materialKit = {
  ...
  initAtvImg: function () {
    $('.card-atv').each(function () {
      ...
      var atv_image_layer =
        '<div class="atvImg-layer" data-img="' + img_src + '"/>'
  ...
  initColoredShadows: function () {
    if (materialKit.misc.colored_shadows == true) {
      if (!materialKit.misc.isWindows) {
        $('.card:not([data-colored-shadow="false"]) .card-image').each(
          function () {
            var $card_img = $(this)
            ...
            if (is_on_dark_screen == 0) {
              ...
              var is_rotating =
                $card_img.closest('.card-rotate').length == 1
  ...
  checkScrollForTransparentNavbar: function () {
    ...
    } else if (!materialKit.misc.transparent) {
